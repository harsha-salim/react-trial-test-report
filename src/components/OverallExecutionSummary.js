...
export const OverAllExecutionSummary = (props) => {
  ...
  return (
    <div className="overall-execution-summary-data">
      <h5 className="test-summary-header summary-text-heading">
            ...
            return (
              <tr className="table-row" key={key}>
                ...
                <td className="table-cell">
                  {" "}
                  {result.deviceInfo.platformName}{" "}
                </td>
                <td className="table-cell">
                  {" "}
                  {result.deviceInfo.platformVersion}{" "}
                </td>
                <td className="table-cell">
                  {" "}
                  {result.deviceInfo.deviceManufacturer}{" "}
                </td>
                <td className="table-cell">
                  {" "}
